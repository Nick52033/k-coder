...
项目会先实现一个小型、可测试的智能体运行时，再按受控阶段逐步发展成成熟的编程智能体工作台。完整开发顺序和验收门槛见 [开发路线图](docs/sys/开发路线图.md)。
...
- [开发路线图](docs/sys/开发路线图.md)
- [运行时架构](docs/sys/架构.md)
- [机器人工作流设计](docs/sys/机器人工作流设计.md)
- [智能体协作规则](AGENTS.md)
