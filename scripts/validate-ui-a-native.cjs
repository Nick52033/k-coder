...
(async () => {
  ...
  try {
    ...
    await page.screenshot({ path: 'docs/sys/ui-a-native-light.png' });
    screenshots.push('ui-a-native-light.png');
    await page.getByRole('button', { name: '切换到深色模式', exact: true }).click();
    await expect(page.locator('html')).toHaveAttribute('data-theme', 'dark');
    await page.screenshot({ path: 'docs/sys/ui-a-native-dark.png' });
    ...
    await page.screenshot({ path: 'docs/sys/ui-a-native-workbench.png' });
