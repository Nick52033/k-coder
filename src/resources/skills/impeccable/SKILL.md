---
name: impeccable
description: Use for frontend design, redesign, critique, audit, polish, optimization, animation, color, accessibility, responsive behavior, UX copy, and design-system work across websites, dashboards, app shells, components, forms, settings, onboarding, and empty states. Covers visual hierarchy, information architecture, typography, spacing, motion, performance, i18n, error states, and browser iteration. Not for backend-only or non-UI tasks.
triggers:
  - impeccable
  - polish frontend
  - 界面优化
