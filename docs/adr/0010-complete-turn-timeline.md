...
- 状态：已接受；第 6 项中的固定 Token 上限已由 ADR 0012 取代，固定 Provider/工具调用次数上限已由 ADR 0013 取代；第 10、11、13 项的终态折叠规则于 2026-08-09 由 `P10-086` 修订，第 11 项的审计事件可见性由同日的 `P10-087` 修订，第 9、11 项的 reasoning 摘要可见性由同日的 `P10-088` 修订，第 10 项的完成态工具组图标语义由同日的 `P10-090` 修订
- 日期：2026-08-02
