...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::threads::read_thread,
            commands::threads::read_thread_history,
            commands::threads::list_thread_turns,
            commands::threads::list_thread_items,
            commands::threads::archive_thread,
            commands::threads::compact_thread,
            commands::threads::rebuild_session_projection,
            commands::turn_start,
            commands::turn_retry,
