---
name: "imagegen"
description: "Generate or edit raster images for website assets, illustrations, textures, sprites, mockups, UI wireframes, product visuals, logos, infographics, or transparent cutouts. Use when the output should be a bitmap asset; prefer repo-native SVG, HTML/CSS, canvas, or existing vector assets when they are a better fit."
triggers:
  - imagegen
  - image generation
  - 生成图片
