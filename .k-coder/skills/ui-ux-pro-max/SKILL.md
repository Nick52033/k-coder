---
name: ui-ux-pro-max
description: "UI/UX design intelligence for web and mobile, backed by local searchable data on styles, color palettes, font pairings, product types, UX guidelines, icons, motion presets, charts, and common stacks. Use when designing or reviewing pages, components, color, typography, layout, accessibility, animation, or data visualization."
triggers:
  - ui ux
  - UI设计
risk: write
